...
final post1 = ProductPost(product1.user, product1, "글의 내용입니다", "서울 특별시 주소", 3, 10, DateTime.now().subtract(30.minutes));
final post2 = ProductPost(product2.user, product2, "글의 내용입니다", "광주 광역시 주소", 20, 30, DateTime.now().subtract(55.minutes));
final post3 = ProductPost(product3.user, product3, "글의 내용입니다", "서울 특별시 주소", 5, 1, DateTime.now().subtract(5.hours));
